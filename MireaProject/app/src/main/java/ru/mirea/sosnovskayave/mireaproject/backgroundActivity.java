...
public class backgroundActivity extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Constraints constraints = new Constraints.Builder()
                ...
                .build();
        WorkRequest request = new OneTimeWorkRequest.Builder(DailyCatTipWorker.class)
                .setConstraints(constraints)
                .build();
        WorkManager.getInstance(requireContext()).enqueue(request);

        String dailyTip = requireContext().getSharedPreferences("CatTips", Context.MODE_PRIVATE)
                .getString("DailyTip", "Загрузка совета...");
        TextView catTipTextView = view.findViewById(R.id.textView9);
        catTipTextView.setText(dailyTip);
    }
}